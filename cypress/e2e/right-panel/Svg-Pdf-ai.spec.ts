...
describe('SVG & PDF', () => {
  ...
  it('SVG On Laser > Layer', () => {
    ...
    cy.fixture('svg.svg').then((fileContent) => {
      ...
      cy.get(
        '.src-web-app-views-beambox-Right-Panels-LayerPanel-LayerList-module__row--2O-iF'
      ...
      cy.get('symbol#svg_1_image>image')
        .invoke('attr', 'filter')
        .should('eq', 'url(#filter#333333)');
    });
  });
  ...
  it('SVG On Laser > Color', () => {
    ...
    cy.fixture('svg.svg').then((fileContent) => {
      ...
      cy.get('symbol#svg_5_image>image')
        .invoke('attr', 'filter')
        .should('eq', 'url(#filter#333333)');
    });
  });
  ...
  it('SVG On Printing > Layer & Change Color', () => {
    ...
    cy.fixture('svg.svg').then((fileContent) => {
      ...
      cy.get(
        '.src-web-app-views-beambox-Right-Panels-Options-Blocks-MultiColorOptions-module__controls--p0P0u'
      )
        .get('.src-web-app-widgets-ColorPicker-module__trigger----xSM')
        .eq(0)
        .get('.src-web-app-widgets-ColorPicker-module__color--Q6lUp')
        .eq(0)
        .invoke('attr', 'style')
        .should('eq', 'background: rgb(63, 81, 181);');
      cy.get(
        '.src-web-app-views-beambox-Right-Panels-Options-Blocks-MultiColorOptions-module__controls--p0P0u'
      )
        .get('.src-web-app-widgets-ColorPicker-module__trigger----xSM')
    ...
    cy.get('.src-web-app-widgets-ColorPicker-module__preset-block--f1R8T')
      .get('.src-web-app-widgets-ColorPicker-module__inner---5lat')
      .eq(0)
      .click();
